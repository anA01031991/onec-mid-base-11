...
////////////////////////////////////////////////////////////////////////////////
//Добавляет новые реквизиты на форму
...
Процедура ДобавитьПолеКонтактноеЛицоВГруппаШапкаПраво (Форма)
	...
	ПолеВвода.ПутьКДанным = "Объект.EDT_КонтактноеЛицо";
	//--  
КонецПроцедуры
...
Процедура ДополнитьФормуДокументаЗаказПокупателя (Форма)
	...
	ПолеВводаСкидка.ПутьКДанным = "Объект.EDT_СогласованнаяСкидка";
	ПолеВводаСкидка.МаксимальноеЗначение = 100;
	...
	КнопкаКомандыПересчитатьТаблицу = Форма.Элементы.Добавить ("КнопкаПересчитатьТаблицу", Тип ("КнопкаФормы"), Форма.Элементы.ГруппаСкидка);
	КнопкаКомандыПересчитатьТаблицу.ИмяКоманды = "ПересчитатьТаблицу";
	КнопкаКомандыПересчитатьТаблицу.Заголовок = "Пересчитать таблицы";
	//--
